...
<form method='post' action='./admin_update.php'>
	...
	<input class='input' type='text' name='id'
		value='<?php print $row->id;?>' readonly><br>
	<h3>First name:</h3>
	<input class='input' type='text' name='fname'
		value='<?php print $row->fname;?>' placeholder='Your first name'><br>
	<h3>Last name:</h3>
	<input class='input' type='text' name='lname'
		value='<?php print $row->lname;?>' placeholder='Your last name'><br>
	<h3>Username:</h3>
	<input class='input' type='text' name='uname'
		value='<?php print $row->uname;?>' placeholder='10 characters or less'><br>
	<h3>Email:</h3>
	<input class='input' type='text' name='email'
		value='<?php print $row->email;?>' placeholder='Your email'><br>
	<h3>Password:</h3>
	<input class='input' type='password' name='paswd'
		value='<?php print $row->paswd;?>'
	...
	<h3>Description:</h3>
	<input class='input' type='text' name='descrip'
		value='<?php print $row->descrip;?>' placeholder='Description'><br> <br>
	<div class='cnt'>
		<input
			...
			onclick='window.history.back()';><br> <br>
	</div>
</form>
<?php
